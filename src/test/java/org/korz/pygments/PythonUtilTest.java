...
public class PythonUtilTest {
    ...
    public void importModule() {
        ...
        PyObject pyVersion = PythonUtil.get(sys, "version");
        String version = PythonUtil.toJava(String.class, pyVersion);
    ...
    public void call() {
        ...
        PyObject ret = PythonUtil.call(f);
    ...
    public void callArg() {
        PyObject test = PythonUtil.importModule("test");
        PyObject f = PythonUtil.get(test, "f");
        PyObject ret = PythonUtil.call(f, Arrays.asList(10));
    ...
    public void callArgs() {
        PyObject test = PythonUtil.importModule("test");
        PyObject f = PythonUtil.get(test, "f");
        PyObject ret = PythonUtil.call(f, Arrays.asList(10, 20, 30, 40));
    ...
    public void callKwargs() {
        ...
        kwargs.put("foo", 42);
        kwargs.put("bar", 0);
        PyObject ret = PythonUtil.call(f, kwargs);
    ...
    public void callArgsKwargs() {
        ...
        kwargs.put("foo", 42);
        kwargs.put("bar", 0);
        PyObject ret = PythonUtil.call(f, args, kwargs);
